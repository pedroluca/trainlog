...
import { ArrowLeft, Volume2, VolumeX, Lock, Eye, EyeOff } from 'lucide-react'
...
export function Settings() {
  ...
  return (
    <main className="flex flex-col items-center min-h-[calc(100vh-11rem)] bg-gray-100 p-4 pb-24">
      {/* Header */}
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 w-full max-w-2xl mb-4 border border-gray-200">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#27AE60] focus:ring-offset-2 ${
              audioEnabled ? 'bg-[#27AE60]' : 'bg-gray-300'
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-[#27AE60]"
      ...
      <div className="bg-gray-50 shadow rounded-xl p-6 w-full max-w-2xl mt-4 border border-gray-200">
