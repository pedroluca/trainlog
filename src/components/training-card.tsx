...
export function TrainingCard(props: TrainingCardProps) {
  ...
  return (
    <div
      className={`shadow-md md:max-w-xl relative rounded-lg overflow-hidden p-6 mx-2 transition-all min-h-[500px] md:min-h-[700px] flex flex-col ${
    ...
    >
      ...
      <h2 className={`text-3xl md:text-4xl font-bold mb-6 mr-7 ${isFinished ? 'text-[#f4f4f4]' : 'text-gray-800 dark:text-gray-100'}`}>{title}</h2>
        ...
        <>
          <div className='mb-auto'>
            {usesProgressiveWeight && progressiveSets ? (
              ...
              <>
                <p className={`text-lg md:text-2xl mb-3 font-bold ${isFinished ? 'text-[#f4f4f4]' : 'text-gray-700 dark:text-gray-300'}`}>
                  Peso Progressivo:
                </p>
                {progressiveSets.map((set, index) => {
                  ...
                  return (
                    <p 
                      key={index} 
                      className={`text-base md:text-xl mb-2 transition-all ${
                        isFinished 
                          ? 'text-[#f4f4f4]' 
                          : isCurrentSet
                ...
                <p className={`text-lg md:text-2xl mb-3 mt-3 ${isFinished ? 'text-[#f4f4f4]' : 'text-gray-700 dark:text-gray-300'}`}>
              ...
              // Normal display
              <>
                <p className={`text-lg md:text-2xl mb-3 ${isFinished ? 'text-[#f4f4f4]' : 'text-gray-700 dark:text-gray-300'}`}>
          ...
          <Button 
            ...
            className='w-full py-4 text-lg md:text-2xl font-bold mt-4'
          >
